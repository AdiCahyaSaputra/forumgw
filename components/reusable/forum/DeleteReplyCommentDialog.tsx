...
const DeleteReplyCommentDialog: React.FC<TDeleteDialog> = ({
  reply_comment_id,
  openDeleteDialog,
  setOpenDeleteDialog,
  onCommentChange
  ...
  const { mutate: deleteReplyComment, isPending } =
    trpc.comment.deleteReplyComment.useMutation();
...
export default DeleteReplyCommentDialog;
